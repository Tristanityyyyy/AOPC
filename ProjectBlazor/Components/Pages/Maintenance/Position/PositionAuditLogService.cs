...
public class PositionAuditLogService
{
    private readonly string _logBasePath = @"C:\Applications\AOPC\Logs\Position";
    ...
    private async Task WriteLogAsync(string actionName, object logEntry)
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine($"Position audit log error: {ex.Message}");
        }
    }
}
