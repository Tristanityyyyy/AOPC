...
public class CorporateAuditLogService
{
    private readonly string _logBasePath = @"C:\Applications\AOPC\Logs\Corporate";
    ...
    private async Task WriteLogAsync(string actionName, object logEntry)
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine($"Corporate audit log error: {ex.Message}");
        }
    }
}
